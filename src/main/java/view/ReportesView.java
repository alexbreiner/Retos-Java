...
public class ReportesView {
    ...
    public void proyectosFinanciadosPorBanco(String banco) {
        ...
        if (banco != null && !banco.isBlank()) {
            ...
            if (banco.equals("Conavi")) {
                try {
                    ArrayList<ProyectoBancoVo> bancoVos = reporterController.consultarProyectoBancoVos(banco);
                    for (ProyectoBancoVo proyectoBancoVo: bancoVos) {
                        System.out.println(String.format("%3s %-25s %-20s %-20s %-1s %-30s",
    ...
    public void totalAdeudadoPorProyectosSuperioresALimite(Double limiteInferior) {
        ...
        if (limiteInferior != null) {
            ...
            try {
                ArrayList<DeudasPorProyectoVo> deudasPorProyectos = reporterController.consultarDeudasProyectos(limiteInferior);
